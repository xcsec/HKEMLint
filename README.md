...
The dataset contains 41 open-source hybrid KEM implementations across C, C++, Go, Rust, and Java, including wolfSSL, BoringSSL, AWS-LC, OpenSSL, Go crypto/tls, libsignal, Mullvad VPN, and others.
